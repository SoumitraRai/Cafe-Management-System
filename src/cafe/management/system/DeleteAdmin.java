...
public class DeleteAdmin extends javax.swing.JFrame {
    ...
    public void showtable(){
        ...
        while(itr.hasNext()){
            Admin a=itr.next();
            dtm.addRow(new Object[]{a.getId(),a.getPassword()});
        }
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(298, 174, -1, -1));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(204, 204, 0));
        jLabel1.setText("DELETE  ADMIN");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(387, 54, -1, -1));
        ...
        jLabel2.setText("*Click on row to delete admin");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 620, -1, -1));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        int a = JOptionPane.showConfirmDialog(null, "Do You Really Want to Delete This Admin?", "Select", JOptionPane.YES_NO_OPTION);
        if(a==0){
            AdminDao.delete(id);
            showtable();
        }
